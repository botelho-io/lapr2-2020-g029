...
| | ... creates Organization instances? | RegistOrganization | By applying the Creator (R1) it would be the “App".But, by applying HC + LC to the “App", this delegates that responsibility to the “RegistOrganization".
|2. the sistem request the organization data (i.e. name) ,one manager of that organization (i.e. name, email and password) and one collaborator of the same organization  (i.e. name, email and password).||||
