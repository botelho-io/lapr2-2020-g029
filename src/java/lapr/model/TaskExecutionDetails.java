...
public class TaskExecutionDetails implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        return Double.compare(that.m_dDayHours, m_dDayHours) == 0 &&
    ...
    @Override
    public int hashCode() {
        return Objects.hash(m_oEndDate, m_dDayHours, m_strDescription);
    }
}
