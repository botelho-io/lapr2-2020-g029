    ...
    private Map<Freelancer, String> getMessages() {
        ...
        for(final Freelancer fre: fre__ad_dt.keySet()) {
            ...
            if(pctDelayed > percentageDelayedTransactions) {
                msg += String.format("%s you have a percentage of delayed tasks higher than %f%% (%f%%), meaning that you are falling behind the average. ",(msg.isEmpty()?"we have noticed that":"furthermore,"), percentageDelayedTransactions, pctDelayed);
            }
            if(!msg.isEmpty()) {
