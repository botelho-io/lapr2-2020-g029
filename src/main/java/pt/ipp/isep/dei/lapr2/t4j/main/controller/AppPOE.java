...
package pt.ipp.isep.dei.lapr2.t4j.main.controller;
...
import pt.ipp.isep.dei.lapr2.t4j.autorizacao.model.PapelUtilizador;
import pt.ipp.isep.dei.lapr2.t4j.main.model.Administrator;
import pt.ipp.isep.dei.lapr2.t4j.main.model.App;
import pt.ipp.isep.dei.lapr2.t4j.main.utils.Constants;
import pt.ipp.isep.dei.lapr2.t4j.autorizacao.AutorizacaoFacade;
import pt.ipp.isep.dei.lapr2.t4j.autorizacao.model.SessaoUtilizador;
...
public class AppPOE
{
    ...
    private void bootstrap()
    {
        ...
        Administrator adm = new Administrator("Admin Joe", "admin@dei.pt", "password");
